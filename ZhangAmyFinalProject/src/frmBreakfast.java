 ...
 * Calculates the calories and cost for breakfast items selected
 */
public class frmBreakfast extends javax.swing.JFrame {
    //Declaring a string array that stores the names of food items eaten at home during breakfast
    final String [] STRHOMEITEMSARR = {"Fruit Cup", "Cereal", "Scrambled  Eggs", "Parfait", "Milk", "Banana"};
    //Declaring a string array that stores the names of food items eaten at a store during breakfast
    final String [] STRSTOREITEMSARR = {"Pancake", "Grilled Cheese Sandwich", "Waffle", "Steamed Bun", "Coffee", "Muffin"};
    
    //Declaring an integer array that stores the calories of food items eaten at home during breakfast
    final int [] INTHOMECALSARR = {76, 379, 91, 125, 122, 110};
    //Declaring an integer array that stores the calories of food items eaten at a store during breakfast
    final int [] INTSTORECALSARR = {232, 410, 800, 434, 4, 430};
    
    //Declaring a double array that stores the price of food items eaten at home during breakfast
    final double [] DBLHOMEPRICEARR = {3.20, 1.17, 0.33, 1.48, 0.37, 0.30};
    //Declaring a double array that stores the price of food items eaten at a store during breakfast
    final double [] DBLSTOREPRICEARR = {2.99, 2.88, 3.99, 2.99, 1.89, 1.79};
    
    //Declaring a string array that stores the paths to the images of food items eaten at home during breakfast
    final String [] STRHOMEIMAGEARR = {"/imageFruitCup.png", "/imageCereal.png", "/imageScrambledEggs.png", "/imageParfait.png", "/imageMilk.png", "/imageBanana.png"};
    //Declaring a string array that stores the paths to the images of food items eaten at a store during breakfast
    final String [] STRSTOREIMAGEARR = {"/imagePancake.png", "/imageGrilledCheeseSandwich.png", "/imageWaffle.png", "/imageSteamedBun.png", "/imageCoffee.png", "/imageMuffin.png"};
    ...
    private void initComponents() {
        ...
        if (tableShoppingCart.getColumnModel().getColumnCount() > 0) {
            tableShoppingCart.getColumnModel().getColumn(0).setPreferredWidth(175);
        ...
        lblTitle.setText("Breakfast Cost and Calories");
    ...
    private void listBreakfastValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listBreakfastValueChanged
        ...
        intSelectedItem = listBreakfast.getSelectedIndex();
    ...
    private void radioButtonStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonStoreActionPerformed
        ...
        //Displays the listmodel in the Jlist listBreakfast
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (listBreakfast.getSelectedIndex() == -1)
        {
        ...
        { 
            ...
            while (!isItemRepeat && !isRowEmpty && intSelectedRow < 7){
                ...
                if (tableModel.getValueAt(intSelectedRow, 0).equals(listBreakfast.getSelectedValue()))
                {
