 ...
 * Calculates the calories and cost for dinner items selected
 */
public class frmDinner extends javax.swing.JFrame {
    //Declaring a string array that stores the names of food items eaten at home during dinner
    final String [] STRHOMEITEMSARR = {"Mushroom Soup", "Egg and Tomatoes", "Dumplings", "Green Beans", "Rice", "Steamed Buns"};
    //Declaring a string array that stores the names of food items eaten at a store during dinner
    final String [] STRSTOREITEMSARR = {"Lo Mein", "Burger", "Lasagna", "Lobster", "Spaghetti", "Soda"};
    
    //Declaring an integer array that stores the calories of food items eaten at home during dinner
    final int [] INTHOMECALSARR = {410, 550, 814, 225, 420, 434};
    //Declaring an integer array that stores the calories of food items eaten at a store during dinner
    final int [] INTSTORECALSARR = {660, 698, 600, 972, 430, 0};
    
    //Declaring a double array that stores the price of food items eaten at home during dinner
    final double [] DBLHOMEPRICEARR = {1.47, 3.47, 3.50, 2.19,1.49, 2.99};
    //Declaring a double array that stores the price of food items eaten at a store during dinner
    final double [] DBLSTOREPRICEARR = {4.99, 8.99, 4.29, 27.99,  12.99, 2.25};
    
    //Declaring a string array that stores the paths to the images of food items eaten at home during dinner
    final String [] STRHOMEIMAGEARR = {"/imageMushroomSoup.png", "/imageEggAndTomatoes.png", "/imageDumpling.png", "/imageGreenBeans.png", "/imageRice.png", "/imageSteamedBun.png"};
    //Declaring a string array that stores the paths to the images of food items eaten at a store during dinner
    final String [] STRSTOREIMAGEARR = {"/imageLoMein.png", "/imageBurger.png", "/imageLasagna.png", "/imageLobster.png", "/imageSpaghetti.png", "/imageSoda.png"};
    ...
    private void initComponents() {
        ...
        listDinner = new javax.swing.JList<>();
        ...
        listDinner.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        listDinner.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                listDinnerValueChanged(evt);
            }
        });
        jScrollPane4.setViewportView(listDinner);
        ...
        lblTitle.setText("Dinner Cost and Calories");
    ...
    //Creating a listModel that can be used in each button method to display in listDinner
    javax.swing.DefaultListModel listModel = new javax.swing.DefaultListModel();

    private void listDinnerValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listDinnerValueChanged
        ...
        intSelectedItem = listDinner.getSelectedIndex();
    ...
    }//GEN-LAST:event_listDinnerValueChanged
    ...
    private void radioButtonStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonStoreActionPerformed
        ...
        //Displays the listmodel in the Jlist listDinner
        listDinner.setModel(listModel);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (listDinner.getSelectedIndex() == -1)
        {
        ...
        { 
            ...
            while (!isItemRepeat && !isRowEmpty && intSelectedRow < 7){
                ...
                if (tableModel.getValueAt(intSelectedRow, 0).equals(listDinner.getSelectedValue()))
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDinner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JList<String> listDinner;
